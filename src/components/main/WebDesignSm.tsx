...
export default function WebDesignSm() {
    return (
        <div className="bg-[url('/assets/home/mobile/image-app-design.jpg')] sm:bg-[url('/assets/home/tablet/image-web-design.jpg')] lg:bg-[url('/assets/home/desktop/image-web-design-small.jpg')] bg-no-repeat bg-center bg-cover w-[20.4375rem] h-[15.625rem] sm:w-[43.0625rem] sm:h-[12.5rem] lg:w-[33.8125rem] lg:h-[19.25rem] rounded-[0.9375rem] flex flex-col items-center justify-center text-center gap-y-1 relative overflow-hidden">
            {/* Overlay */}
