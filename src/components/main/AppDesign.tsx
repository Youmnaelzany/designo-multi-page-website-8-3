...
export default function AppDesign() {
    return (
        <div className="bg-[url('/assets/home/mobile/image-app-design.jpg')] sm:bg-[url('/assets/home/tablet/image-app-design.jpg')] xl:bg-[url('/assets/home/desktop/image-app-design.jpg')] bg-no-repeat bg-center bg-cover w-[20.4375rem] h-[15.625rem] sm:w-[43.0625rem] sm:h-[12.5rem] xl:w-[33.8125rem] xl:h-[19.25rem] rounded-[0.9375rem] flex flex-col items-center justify-center text-center gap-y-1 relative overflow-hidden">
            {/* Overlay */}
