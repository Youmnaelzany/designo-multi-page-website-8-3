...
export default function AboutCard({ desktopImg, tabletImg, mobileImg, title, description, descriptionTwo }: AboutCardProps) {
    return (
        <div className="flex flex-col items-center justify-center lg:flex-row mx-[-1.5rem] sm:mx-0">
            <picture>
                <source media="(min-width: 1024px)" srcSet={desktopImg} />
                <source media="(min-width: 768px)" srcSet={tabletImg} />
                <img src={mobileImg} alt="about-card" />
            </picture>
            <div className="flex flex-col gap-6 items-center justify-center text-center lg:text-left lg:justify-start bg-[#FDF3F0] py-20 px-6 sm:pl-[3.69rem] sm:pr-[3.62rem] lg:py-[6.85em] lg:pr-24 lg:pl-[5.87rem] lg:items-start">
